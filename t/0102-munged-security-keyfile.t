...
# Setup the environment for testing the keyfile.
##
...
# Check if the error can be overridden when the keyfile is not a regular file.
##
...
#   trusted group.
##
test_expect_failure 'keyfile readable by trusted group gid' '
    local GID &&
...
#   trusted group gid.
##
test_expect_failure 'keyfile writable by trusted group gid' '
    local GID &&
    GID=$(ls -l -n "${MUNGE_KEYFILE}" | awk "{ print \$4 }") &&
